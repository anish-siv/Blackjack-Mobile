...
public class Table extends World {
    ...
    public Table() {
        ...
        GreenfootImage pauseImage = new GreenfootImage("pause-button.png");
    ...
    public void pauseAndResume(){
        ...
        String text = "You paused the game, click space bar to continue";
        GreenfootImage inner = new GreenfootImage(text, 20, Color.WHITE, new Color(0, 0, 0, 0));
        int wide = 1000; 
        int high = 1000;
